...
(def players {1 {:player/id 1 :player/name "Bela2" :player/game 1}
              2 {:player/id 2 :player/name "Pistidsa" :player/game 2}
              3 {:player/id 3 :player/name "Magus" :player/game 3}})

(def game-stations {1 {:game-station/id 1 :game-station/name "Crusader" :game-station/game 1 :game-station/player [1]}
                    2 {:game-station/id 2 :game-station/name "Zelda" :game-station/game 2 :game-station/player [2]}
                    3 {:game-station/id 3 :game-station/name "Magus" :game-station/game 3 :game-station/player [3]}
                    4 {:game-station/id 3 :game-station/name "Rubick" :game-station/game 2}})
