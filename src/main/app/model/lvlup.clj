...
(def game-stations {1 {:game-station/id 1
                       :game-station/name "Crusader"
                       :game-station/game {:game/id 1}
                       :game-station/player {:player/id 1}}
                    2 {:game-station/id 2
                       :game-station/name "Zelda"
                       :game-station/game {:game/id 2}
                       :game-station/player {:player/id 2}}
                    3 {:game-station/id 3
                       :game-station/name "Magus"
                       :game-station/game {:game/id 3}
                       :game-station/player {:player/id 3}}
                    4 {:game-station/id 4
